...
| **company** | the brand-registration capability — **transversal**: it belongs to no persona's domain, and a front-desk persona carries it beside its own vertical. One write, keyed by the accent-folded company name, so registering a company again UPDATES it | `company_registration` |
